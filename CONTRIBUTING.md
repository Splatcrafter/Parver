## Contributing to ParVer

Thank you for your interest in contributing to ParVer! 🎉
...
```
Use a meaningful branch name (e.g., `fix/cors-bug` or `feature/security-chain-addition`).
